/**
 * 全部教学内容：企业文化原文、序章脚本、第二/三章的 NPC 对话与选择题、
 * 第一章的模块、测试数据、选项文案，以及行动承诺。
 *
 * 改文案、调题库、换阈值都只改这个文件；需要新增游戏规则时再动 utils/state.js。
 *
...
module.exports = {
  ...
  prologue: [
    ...
    },
    {
      tag: '03 / 你的探索任务',
      title: '点亮能源网络，\n从技术之芯开始。',
      text: '你将成为东鸿文化探索员：认识一块电表，重建模块连接，追溯一次计量异常。每一个技术选择，都对应一种工作态度。',
      nodes: 6
    }
  ],
  // 第二、三章的剧情与选择题，按阶段 id 索引；答对才点亮关卡。
  missions: {
    2: {
      id: '2',
      code: 'CHAPTER 02',
  ...
  chapter: {
    ...
    direction: '创新驱动、技术为本',
    intro:
      '一块电表的价值，不止于亮起的屏幕。它需要把每一次能源变化，变成可信、可用的数据。进入研发实验室，探索技术怎样创造客户价值。',
    steps: ['文化导入', '产品拆解', '模块组装', '精度排查', '方案改进'],
    modules: [
      {
        id: 'sample',
        code: 'S01',
    ...
    tests: [
      { id: 'a', name: '测试点 A', reference: 100, measured: 100.2, error: '+0.2%' },
      { id: 'b', name: '测试点 B', reference: 100, measured: 102.4, error: '+2.4%' },
      { id: 'c', name: '测试点 C', reference: 100, measured: 99.7, error: '−0.3%' }
    ],
    tolerance: 0.5,
    anomaly: 'b',
    remedies: [
      {
        id: 'display',
        title: '只修正显示结果',
        text: '让屏幕读数回到目标值，跳过问题追溯。',
        feedback: '改变显示并没有解决偏差来源。精进要求追溯原因，并保留真实的测试记录。'
      },
      {
        id: 'verify',
        title: '追溯采样与计量链路，再校准复测',
        text: '记录异常，检查链路，校准后验证全部测试点。',
        feedback: '你把“发现问题”变成了“验证改进”。这就是技术为本，也是精进。'
      },
      {
        id: 'ship',
        title: '先交付，后续再观察',
        text: '大部分测试点正常，可以暂时忽略异常。',
        feedback: '单个异常也可能影响客户对数据的信任。不能用交付进度代替技术验证。'
      }
    ],
    innovation: [
      {
        id: 'same',
        title: '沿用只统计用电的旧方案',
        feedback: '新场景包含发电回送，单向统计不足以回答客户的问题。创新从理解新需求开始。'
      },
      {
        id: 'bidirectional',
        title: '组合双向计量与通讯能力，并验证数据',
        feedback: '用经过验证的技术组合回应新需求，让客户看清能源的双向流动。'
      },
      {
        id: 'more',
        title: '先堆叠更多功能，再了解需求',
        feedback: '功能多并不等于有价值。先聚焦客户问题，再探索方案。'
      }
    ],
    retest: [
      { name: '测试点 A', error: '+0.1%' },
      { name: '测试点 B', error: '+0.2%' },
      { name: '测试点 C', error: '−0.1%' }
    ]
  },
  // 文化印记的行动承诺选项，也是完成第一章的必填项。
  actions: [
    '先理解需求，再提出并验证新方案。',
    '发现异常，记录、追溯、改进并复测。',
    '把每一次改进沉淀为团队可复用的经验。'
