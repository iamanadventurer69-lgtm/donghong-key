...
module.exports = {
  ...
  // 打卡答题：每个展区一组题（questions，3~4 题），全部答对才算完成该展区；
  // 单题字段（question/options/answer）保留为第一题，小程序版仍按单题提问。
  quests: [
    {
      id: 'culture',
      icon: '📜',
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 0,
          explain:
            '「微型智能电表行业领跑者」是愿景——我们想走到哪儿；使命回答「为谁做什么」，理念回答「怎么和客户相处」，发展导向是三条走法。'
        },
        {
          question: '下面哪一条不属于东鸿的发展导向？',
          options: [
            '创新驱动、技术为本',
            '国际认证、全球布局',
            '行业聚焦、定制化方案',
          ...
          answer: 3,
          explain:
            '发展导向是「创新驱动、技术为本」「国际认证、全球布局」「行业聚焦、定制化方案」三条。靠低价抢市场不在其中——我们靠技术、认证与聚焦取胜。'
        },
        {
          question: '客户问「你们到底为谁、做什么」，对应东鸿文化里的哪一项？',
          options: ['愿景', '使命', '理念', '价值观'],
          answer: 1,
          explain:
            '使命就是「让每一度电更智能、更安全、更精准」——回答我们存在的意义；愿景是目标，理念是与客户的相处方式。'
        }
      ],
      // 兼容单题字段：小程序版仍按第一题提问
      question: '「成就客户可持续增长」在东鸿文化里属于哪一项？',
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question: '负责「计算电能数据」的是哪一块模块？',
          options: ['采样单元', '计量核心', '通讯模块', '电源模块'],
          answer: 1,
          explain: '四块模块的分工是：采样单元感知、计量核心计算、通讯模块上报、电源模块供电。'
        },
        {
          question: '要把电能数据交给客户的能源管理系统，靠哪块模块？',
          options: ['采样单元', '计量核心', '通讯模块', '电源模块'],
          answer: 2,
          explain:
            '通讯模块是数据出口：数据算出来之后，由它送到能源管理系统；算得准但送不出去，客户一样用不上。'
        },
        {
          question: '现场掉电后表计无法启动，最该先检查哪一块？',
          options: ['采样单元', '计量核心', '通讯模块', '电源模块'],
          answer: 3,
          explain: '电源模块负责给内部模块稳定供电。上电都上不来，先看供电，再谈采样与计算。'
        }
      ],
      question: '现场读数漂移 3%，照片显示采样单元装在了「数据计算」槽位。最可能的原因是？',
      options: ['客户现场干扰太大', '模块装错了位置', '检验阈值设置过松', '通讯协议不匹配'],
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question: '「不满足于能用，持续提高技术与质量标准」对应哪个价值观？',
          options: ['守正', '务实', '创新', '精进'],
          answer: 3,
          explain: '精进＝不满足于「能用」，而是持续把技术与质量标准往上推。'
        },
        {
          question: '「从客户真实需求出发，解决具体问题」对应哪个价值观？',
          options: ['守正', '务实', '创新', '精进'],
          answer: 1,
          explain: '务实＝从客户的真实场景出发，解决具体问题，而不是堆概念。'
        },
        {
          question: '「面对新需求，探索并验证更好的方案」对应哪个价值观？',
          options: ['守正', '务实', '创新', '精进'],
          answer: 2,
          explain: '创新＝敢试新方案，并且用验证把它坐实；只提方案不验证就不算创新。'
        }
      ],
      question: '四个价值观中，「守正」最贴近下面哪种行为？',
      options: [
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question: '走进北美市场，最常被问到的是哪组认证？',
          options: ['MID / CE', 'UL / ETL', 'SAA / RCM', '只需出厂检验报告'],
          answer: 1,
          explain:
            '北美看 UL / ETL，欧盟看 MID / CE，澳洲看 SAA / RCM——三个市场三套要求，先看清再动手。'
        },
        {
          question: '「认证不是一张标签」，这句话更强调什么？',
          options: [
            '认证只是市场准入的形式',
            '拿到证书就可以长期沿用',
            '它是对质量、规范与可靠性的长期承诺',
          ...
          answer: 2,
          explain:
            '认证背后是质量、规范与可靠性的长期承诺：证书会过期，标准会更新，真正被认可的是持续做对的能力。'
        }
      ],
      question: '教学情境下，产品进入欧盟市场最需要准备哪组认证？',
      options: ['UL / ETL', 'SAA / 其他地区标识', 'MID / CE', '只需企业自测报告'],
